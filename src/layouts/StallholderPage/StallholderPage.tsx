        ...
        <div className="container mt-3">
            <div className="row">
                <div className="col-12 col-md-6">
                    <h1>{stallholder?.attributes.stallName}</h1>
                </div>
                <div className="col-12 col-md-6">
                    <h2>Category: {stallholder?.attributes.category}</h2>
                </div>
            </div>
            <div className="card">
                ...
                <ul className="list-group list-group-flush">
                    <li className="list-group-item">
                        <div className="row">
                            ...
                            <div className="col">
                                Full name: {stallholder?.attributes.contactName}
                                <br />
                                Preferred:{" "}
                                {stallholder?.attributes.preferredName ? (
                                    stallholder?.attributes.preferredName
                                ) : (
                                    <em>None</em>
                                )}
                    ...
                    <li className="list-group-item">
                        ...
                        {stallholder?.attributes.email}
                    </li>
                    <li className="list-group-item">
                        Regular{" "}
                        {stallholder?.attributes.regular ? (
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                width="16"
                                height="16"
                    ...
                    <li className="list-group-item">
                        Stall Size: {stallholder?.attributes.stallSize}
                    </li>
                    <li className="list-group-item">
                        Characteristics:{" "}
                        {stallholder?.attributes.characteristics
                            ? stallholder.attributes.characteristics
                            : "None"}
                    </li>
                </ul>
