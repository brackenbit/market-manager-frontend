...
test("calls onChange with new value when input is clicked", async () => {
    ...
    // Act
    const initiallyCheckedElement = screen.getByLabelText("initiallyChecked");
    ...
    // Assert
    expect(handleChangeMock1).toHaveBeenCalledWith("initiallyChecked", false);
    expect(handleChangeMock2).toHaveBeenCalledWith("initiallyUnchecked", true);
});
